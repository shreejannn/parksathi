...
export default function BottomNav({
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-black/5 bg-white/95 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur">
            ...
            <li key={href} className="flex-1">
              ...
              >
                <Icon
                  className={clsx(
                    "h-6 w-6 transition",
                    active ? "text-[#ffc948]" : "text-night-800/35",
                  )}
